# I refer to web page template here: https://www.w3schools.com/w3css/tryw3css_templates_parallax.htm#home
import traceback
from flask import render_template, request, redirect, url_for
import logging.config
from flask import Flask
from create_db import Price_Prediction
...
# extract all columns from dataframe that is used for modeling
...
def clean_input(state, region_input, housing_type, sqfeet, beds, baths, comes_furnished_input, 
    ...
    """Clean user input and do necessary transformation"""
